...
<div class="container">
  ...
  <header id="head" role="banner">
    ...
    <div class="eleven columns omega" id="headright">
      ...
      <?php if ($googleplus_url): ?><li> <a href="<?php print $googleplus_url; ?>" target="_blank"> <img src="<?php print $theme_path_social; ?>/images/pinterest2.png"> </a> </li> <?php endif; ?>
      ...
      <?php /*<li> <a href="<?php print $front_page; ?>rss.xml"> <img src="<?php print $theme_path_social; ?>/images/rss.png"> </a> </li>*/?>
        </ul>
      </div>
      <?php endif; ?>
