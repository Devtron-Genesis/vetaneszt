<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix node-mt"<?php print $attributes; ?>>
    ...
    <div class="post-submitted-info">
        <?php $event_start_date = strtotime($node->field_event_start_date['und'][0]['value']);?>
        <?php if ($display_submitted): ?>
        <div class="submitted-date">
          <?php $custom_month = format_date($event_start_date, 'custom', 'M'); ?>
          <?php $custom_day = format_date($event_start_date, 'custom', 'd'); ?>
          <?php $custom_year = format_date($event_start_date, 'custom', 'Y'); ?>
